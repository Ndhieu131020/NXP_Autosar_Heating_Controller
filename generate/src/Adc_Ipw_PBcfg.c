...
/* Check if Adc_Ipw__PBcfg.c file and Adc_Ipw_CfgDefines.h file are of the same vendor */
...
/* Check if Adc_Ipw_PBcfg.c file and Adc_Ipw_CfgDefines.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Adc_Ipw__PBcfg.c and Adc_Ipw_CfgDefines.h are different"
#endif
...
/* Check if Adc_Ipw__PBcfg.c file and Adc_Ipw__PBcfg.h file are of the same Software version */
...
{
    { &AdcIpConfig_0, NULL_PTR }, /* AdcConfigPtrArr */
    { &PdbAdcIpConfig_0, NULL_PTR }, /* PdbConfig */
    { 0U, ADC_IPW_INVALID_LOGICAL_UNIT_ID }, /* AdcPhysicalIdArr */
#if (ADC_DUAL_CLOCK_MODE == STD_ON)
    { NULL_PTR, NULL_PTR }, /* AdcAltClockConfig */
#endif /* (ADC_DUAL_CLOCK_MODE == STD_ON) */
#if (ADC_ENABLE_LIMIT_CHECK == STD_ON)
    { ChannelLimitCheckingConfig_0, NULL_PTR }, /* ChannelLimitCheckingConfigs */
#endif /* (ADC_ENABLE_LIMIT_CHECK == STD_ON) */
    /* Mapping */
    {
