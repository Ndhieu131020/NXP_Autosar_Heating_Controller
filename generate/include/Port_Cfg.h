...
*
*/
#define PortConf_PortPin_PortPin_LED_GREEN 0
#define PortConf_PortPin_PortPin_POT 1
#define PortConf_PortPin_PortPin_LED_RED 2
#define PortConf_PortPin_PortPin_UART1_Rx 3
#define PortConf_PortPin_PortPin_UART1_Tx 4
#define PortConf_PortPin_PortPin_LED_BLUE 5
