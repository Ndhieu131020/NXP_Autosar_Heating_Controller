...
/**
* @brief          Symbolic name for the channel DioChannel_LED_GREEN.
*
*/
#define DioConf_DioChannel_DioChannel_LED_GREEN  ((uint16)0x0070U)
/**
* @brief          Symbolic name for the channel DioChannel_LED_RED.
*
*/
#define DioConf_DioChannel_DioChannel_LED_RED  ((uint16)0x006fU)
/**
* @brief          Symbolic name for the channel DioChannel_LED_BLUE.
*
*/
#define DioConf_DioChannel_DioChannel_LED_BLUE  ((uint16)0x0060U)
